...
//        String cat = "cat9";
        ...
        Bid new1 = auctionServices.newBid(item1, buyer, auctionServices.getMoneyObject(10, "eur"));
        assertEquals(emailb, new1.getBuyer().getEmail());

        // lager bod
        Bid new2 = auctionServices.newBid(item1, buyer2, auctionServices.getMoneyObject(9, "eur"));
        assertNull(new2);

        // hoger bod
        Bid new3 = auctionServices.newBid(item1, buyer2, auctionServices.getMoneyObject(11, "eur"));
